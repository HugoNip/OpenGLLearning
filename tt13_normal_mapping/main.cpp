...
int main( void )
{
    ...
    // And one for the 3x3 ModelView matrix. This is strictly speaking not 
    // necessary, but it’s easier ; more about this later. 
    // We just need the 3x3 upper-left part because we will multiply 
    // directions, so we can drop the translation part.
    ...
    // Since we need our tangents and bitangents on top of our normals, 
    // we have to compute them for the whole mesh. 
    computeTangentBasis(
    ...
    do
    {
		...
		/**
		// give our matrices to OpenGL’s old-school pipeline
		...
		// Normals
		// draw your lines (in this case, normals, normalized and multiplied by 0.1, 
		// and applied at the correct vertex):
		glColor3f(0, 0, 1);
		glBegin(GL_LINES);
