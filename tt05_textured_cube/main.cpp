...
int main(void) 
{
    ...
    // each handle associates to shader uniform
    ...
    glm::mat4 View = glm::lookAt(
        glm::vec3(4, 3, 3),     // camera location, world coordinate
    ...
    // Load texture using any two methods
